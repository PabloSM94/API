...
//--Uso de Handlebars--------------
const handlebars = require("express-handlebars");  //Modulo Handlebars
...
app.get("/", (req,res)=>{
    res.render("nuevoProducto", {productos: camposdeFormulario()})
})
...
app.get("/productos", (req,res)=>{
    ...
    if(isObjEmpty(productosJSON)){
        res.render("visualizarProductos2")
    } else {
        res.render("visualizarProductos",{productos: productosJSON})
    }
